...
class DocParserTestCase(unittest.TestCase):
    ...
    def test_h1(self):
        self._test_tag(self.contents[0], 'h1')
    ...
    def test_h2(self):
        self._test_tag(self.contents[1], 'h2')

    def test_h3(self):
        self._test_tag(self.contents[2], 'h3')

    def test_p(self):
        self._test_tag(self.contents[3], 'p')
    ...
    def test_ul(self):
        self._test_tag(self.contents[8], 'ul')
    ...
    def test_ol(self):
        self._test_tag(self.contents[9], 'ol')
    ...
    def _test_tag(self, tag, tag_name):
